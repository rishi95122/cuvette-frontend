...
const JobCard = ({ job }) =>{ 
  ...
  const notifyUsers=async()=>{
    ...
    try {
      const response =await axios.post(`${import.meta.env.VITE_API_BACKEND_URI}/api/email/notify`,job,{headers})
  ...
  return (
    <div className="bg-white flex flex-col justify-between shadow-lg rounded-lg overflow-hidden">
      ...
      <div >
      {job?.candidates.length>0 &&  <div className="flex items-center space-x-2 px-2 pb-3  ">
